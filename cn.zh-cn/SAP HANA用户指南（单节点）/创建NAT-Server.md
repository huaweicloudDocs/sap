...
3.  在左侧导航栏，单击![](figures/002-10.png)，选择“计算 \> 弹性云服务器“，进入“弹性云服务器“管理界面。
...
5.  根据界面提示，配置NAT Server基础信息，如[表1](#table15048540213231)所示。
    ...
    **表 1**  NAT Server基础配置
    ...
    <tr id="row77488374912"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p0670201392"><a name="p0670201392"></a><a name="p0670201392"></a>CPU架构</p>
    </td>
...
7.  根据界面提示，配置NAT Server云服务器网络信息，如[表2](#table16563101213313)所示。
    ...
    **表 2**  NAT Server网络配置
    ...
    <tr id="row17374181916303"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p188317214016"><a name="p188317214016"></a><a name="p188317214016"></a>线路</p>
    </td>
    ...
    <tr id="row237411194306"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p3840104412100"><a name="p3840104412100"></a><a name="p3840104412100"></a>公网带宽</p>
    </td>
    ...
    <tr id="row1437391910303"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p0156113801018"><a name="p0156113801018"></a><a name="p0156113801018"></a>带宽大小</p>
    </td>
...
9.  根据界面提示，配置NAT Server云服务器高级信息，如[表3](#table17181316193420)所示。
    ...
    **表 3**  NAT Server高级配置
    ...
    <tr id="row6952147135116"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p2750046182612"><a name="p2750046182612"></a><a name="p2750046182612"></a>云备份</p>
    </td>
...
11. 根据界面提示，确认NAT Server云服务器配置信息，如[表4](#table127431131614)所示。
    ...
    **表 4**  NAT Server配置信息
    ...
    <tr id="row1543818118312"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p58601590496"><a name="p58601590496"></a><a name="p58601590496"></a>协议</p>
    </td>

...
5.  根据界面提示，配置HANA云服务器基础信息，如[表1](#table15048540213231)所示。
    ...
    **表 1**  HANA云服务器基础配置
    ...
    <td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p44344974213231"><a name="p44344974213231"></a><a name="p44344974213231"></a>请选择<span class="parmvalue" id="parmvalue42209921213231"><a name="parmvalue42209921213231"></a><a name="parmvalue42209921213231"></a>“公共镜像”</span>，请参见<a href="SAP-HANA节点规划.md#table277447592121">表8</a>选择对应的SAP HANA云服务器镜像。</p>
    </td>
    </tr>
...
7.  根据界面提示，配置HANA云服务器网络信息，如[表2](#table16563101213313)所示。
    ...
    **表 2**  HANA云服务器网络配置
    ...
    <p id="p1564171212317"><a name="p1564171212317"></a><a name="p1564171212317"></a>若需添加，可单击<span class="uicontrol" id="uicontrol556415128313"><a name="uicontrol556415128313"></a><a name="uicontrol556415128313"></a>“增加一块网卡”</span>增加磁盘。</p>
...
9.  根据界面提示，配置HANA云服务器高级信息，如[表3](#table17181316193420)所示。
    ...
    **表 3**  HANA云服务器高级配置
    ...
    <tr id="row7500201019323"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p25001810163214"><a name="p25001810163214"></a><a name="p25001810163214"></a>高级选项</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p18184101613349"><a name="p18184101613349"></a><a name="p18184101613349"></a>此参数需要勾选<span class="parmname" id="parmname918441673417"><a name="parmname918441673417"></a><a name="parmname918441673417"></a>“高级选项”</span>后面的<span class="uicontrol" id="uicontrol151847166349"><a name="uicontrol151847166349"></a><a name="uicontrol151847166349"></a>“现在配置”</span>，展开页面后才能看到。</p>
    <p id="p61848160341"><a name="p61848160341"></a><a name="p61848160341"></a>用于指定HANA云服务器的服务器组。系统在创建云服务器时，会将属于同一个服务器组的HANA云服务器，创建在不同的物理主机上，以保证HANA云服务器运行的可靠性。</p>
    ...
    <div class="note" id="note1185121613420"><a name="note1185121613420"></a><a name="note1185121613420"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p91851416143411"><a name="p91851416143411"></a><a name="p91851416143411"></a>在公有云管理控制台，单击<span class="menucascade" id="menucascade2018518169345"><a name="menucascade2018518169345"></a><a name="menucascade2018518169345"></a>“<span class="uicontrol" id="uicontrol13186121616346"><a name="uicontrol13186121616346"></a><a name="uicontrol13186121616346"></a>管理与部署</span> &gt; <span class="uicontrol" id="uicontrol7186151693415"><a name="uicontrol7186151693415"></a><a name="uicontrol7186151693415"></a>统一身份认证服务</span>”</span>后，在左侧单击<span class="menucascade" id="menucascade118661613343"><a name="menucascade118661613343"></a><a name="menucascade118661613343"></a>“<span class="uicontrol" id="uicontrol1518641643420"><a name="uicontrol1518641643420"></a><a name="uicontrol1518641643420"></a>委托</span>”</span>，然后在右侧单击<span class="uicontrol" id="uicontrol118641610341"><a name="uicontrol118641610341"></a><a name="uicontrol118641610341"></a>“创建委托”</span>创建。</p>
    <p id="p20186101614343"><a name="p20186101614343"></a><a name="p20186101614343"></a>参数说明如下：</p>
    <a name="ul15186216143413"></a><a name="ul15186216143413"></a><ul id="ul15186216143413"><li>委托名称：DataProviderAccess</li><li>委托类型：云服务</li><li>云服务：弹性云服务器 ECS 裸金属服务器 BMS</li><li>持续时间：使用默认值。</li><li>权限选择：选择本云服务器所在的“所属区域”对应的“项目”，单击“修改”，配置“基本 &gt; Tenant Guest”权限。</li></ul>
    </div></div>
    </td>
    </tr>
    </tbody>
...
15. 根据需要，继续创建其他HANA云服务器。
16. 修改所有HANA云服务器的“root“帐号密码。
